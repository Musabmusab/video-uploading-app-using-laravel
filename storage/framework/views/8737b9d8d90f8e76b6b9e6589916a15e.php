...
<body>
  ...
  <header class="py-3 bg-dark">
   <a class="m-3 btn btn-success" href="<?php echo e(url('/show')); ?>">Back</a>
  ...
  <div class="container d-flex align-items-center justify-content-center" style="height: calc(100vh - 160px);">
    <div class="form-container w-100 ">
      ...
      <form method="post" action="<?php echo e(url('/uploadproduct')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php /**PATH D:\laravel 11 project\video uploading app\routing and controller\resources\views/home.blade.php ENDPATH**/ ?>